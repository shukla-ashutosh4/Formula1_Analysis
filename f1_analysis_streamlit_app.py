...
for i in range(len(podiumFinishes)):
    ax.text(podiumFinishes[i]-1, i+0.2, "{:>3}".format(podiumFinishes[i]),fontproperties=font_prop, fontsize=16, color='k')
...
ax.tick_params(fontproperties=font_prop,axis='x', colors='#bbbbbb')
ax.tick_params(fontproperties=font_prop,axis='y', colors='#bbbbbb')
